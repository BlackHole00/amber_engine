...
Mod_Manager_Register_ModLoader_Proc :: #type proc(mod_loader: Mod_Loader) -> bool
Mod_Manager_Remove_ModLoader_Proc :: #type proc(loader_id: Mod_Loader_Id) -> bool
Mod_Manager_Get_ModLoader_Id :: #type proc(loader_name: string) -> Mod_Loader_Id

Mod_Manager_Is_ModLoaderId_Valid :: #type proc(loader_id: Mod_Loader_Id) -> bool
Mod_Manager_Is_ModLoader_Registered :: #type proc(loader_name: string) -> bool

Mod_Manager_Can_Load_Extension :: #type proc(file_name: string) -> bool

Mod_Manager_Queue_Load_Mod_Proc :: #type proc(mod_path: string) -> (Mod_Load_Error, Mod_Id)
Mod_Manager_Queue_Load_Folder_Proc :: #type proc(folder_path: string) -> (Mod_Load_Error, Mod_Id)
...
Mod_Manager_Get_Mod_Raw_Handle_Proc :: #type proc(mod_id: Mod_Id) -> dynlib.Library
...
Mod_Manager_Get_ModInfo_List_Proc :: #type proc() -> []Mod_Info
